...
Note that Spotify's authentication service requires the web demo to be hosted at a whitelisted redirect URI. This is the reason for running `http-server` at port 9000 (merely opening `index.html` in a browser will not work).

For more information about authentication, see the official [Spotify Web API documentation](https://developer.spotify.com/documentation/web-api/tutorials/code-pkce-flow).
...
- [Spotify Web API documentation](https://developer.spotify.com/documentation/web-api/tutorials/code-pkce-flow)
